...
class TypeChambre extends \App\Entity\TypeChambre implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\TypeChambre' . "\0" . 'id', '' . "\0" . 'App\\Entity\\TypeChambre' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\TypeChambre' . "\0" . 'chambres'];
        }
     ...
     * {@inheritDoc}
     */
    public function setLibelle(string $libelle): \App\Entity\TypeChambre
    {
